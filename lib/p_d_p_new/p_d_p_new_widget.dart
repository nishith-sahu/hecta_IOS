...
import 'p_d_p_new_model.dart';
export 'p_d_p_new_model.dart';

class PDPNewWidget extends StatefulWidget {
  const PDPNewWidget({
    Key? key,
    this.propRef,
  }) : super(key: key);
  ...
  @override
  _PDPNewWidgetState createState() => _PDPNewWidgetState();
}

class _PDPNewWidgetState extends State<PDPNewWidget> {
  late PDPNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PDPNewModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'PDP_New'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_D_P_NEW_PAGE_PDP_New_ON_PAGE_LOAD');
      logFirebaseEvent('PDP_New_update_app_state');
      FFAppState().update(() {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarouselsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarouselsRecord> pDPNewCarouselsRecordList = snapshot.data!;
        final pDPNewCarouselsRecord = pDPNewCarouselsRecordList.isNotEmpty
            ? pDPNewCarouselsRecordList.first
            : null;
        return Title(
            title: 'PDP_New',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: StreamBuilder<PropertiesRecord>(
                              stream:
                                  PropertiesRecord.getDocument(widget.propRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'P_D_P_NEW_PAGE_StaticMap_3wwdgnhc_ON_TAP');
                                                          logFirebaseEvent(
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        custom_widgets
                                                                          ...
                                                                          height:
                                                                              22,
                                                                          value: columnPropertiesRecord.estimatedValue == null || columnPropertiesRecord.estimatedValue == ''
                                                                              ? 'N/A'
                                                                              : functions.format(functions.toInt(columnPropertiesRecord.estimatedValue!)),
                                                                        ),
                                                                        Padding(
                                                                        ...
                                                                        Builder(
                                                                          builder: (context) =>
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('P_D_P_NEW_PAGE_Icon_ycgfkyg8_ON_TAP');
                                                                                logFirebaseEvent('Icon_share');
                                                                                await Share.share(
                                                                                  functions.shareProperty(columnPropertiesRecord.title!, columnPropertiesRecord.auctionReservePrice!.toString(), columnPropertiesRecord.perUnitRate!, columnPropertiesRecord.auctionDiscount!, columnPropertiesRecord.applicationEndDate!, columnPropertiesRecord.propertyUrl!, functions.generateMaplink(columnPropertiesRecord.latitude!.toString(), columnPropertiesRecord.longitude!.toString())!),
                                                                        ...
                                                                        if (!columnUserRecord
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('P_D_P_NEW_PAGE_Icon_3wjjt6ct_ON_TAP');
                                                                        ...
                                                                        if (columnUserRecord
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('P_D_P_NEW_PAGE_Icon_cuqmkrmn_ON_TAP');
                                                                                logFirebaseEvent('Icon_backend_call');
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'P_D_P_NEW_PAGE_Row_4fyegf69_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Row_launch_u_r_l');
                                                                          await launchURL(
                                                                              columnPropertiesRecord.noticeEnglish!);
                                                              ...
                                                              return Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_D_P_NEW_PAGE_Text_6lbeimhf_ON_TAP');
                                                                        ...
                                                                        return Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () async {
                                                                                logFirebaseEvent('P_D_P_NEW_PAGE_Image_8hby9gte_ON_TAP');
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: InkWell(
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'P_D_P_NEW_PAGE_Text_4xd4hdwg_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Text_launch_u_r_l');
                                                                await launchURL(
                                                                    columnPropertiesRecord
                                                              ...
                                                              children: [
                                                                ...
                                                                FFButtonWidget(
                                                                  onPressed: columnUserRecord
                                                                      ...
                                                                      : () async {
                                                                          logFirebaseEvent(
                                                                              'P_D_P_NEW_PAGE_ADD_TO_CART_BTN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Button_backend_call');
                                                                          ...
                                                                          FFAppState()
                                                                              .update(() {
                                                                            FFAppState().subTotal =
                                                                                functions.totalAmt(functions.mapLength(columnUserRecord.cart!.toList()));
                                                                            FFAppState().gst =
                                                                                functions.gst(functions.mapLength(columnUserRecord.cart!.toList()).toDouble());
                                                                            FFAppState().totalamt =
                                                                                functions.addTotal(FFAppState().gst, FFAppState().subTotal);
                                                                          });
                                                                          logFirebaseEvent(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FFButtonWidget(
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_D_P_NEW_PAGE_CONTACT_US_BTN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_call_number');
                                                                        await launchUrl(
                                                                            Uri(
                                                              ...
                                                              Expanded(
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_D_P_NEW_APPLY_WITH_BANK_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_D_P_NEW_TALK_TO_A_LAWYER_BTN_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Button_launch_u_r_l');
                                                                      await launchURL(
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_D_P_NEW_PAGE_Row_fylpe3ke_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Row(
                                                                                                              ...
                                                                                                              children: [
                                                                                                                ...
                                                                                                                if (pDPNewCarouselsRecord!.propertyId!.toList().contains(rowPropertiesRecord.propertyId))
                                                                                                                  Padding(
                                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 10, 0),
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Builder(
                                                                                                                  builder: (context) => Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_D_P_NEW_PAGE_Icon_wnzmmc0i_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_share');
                                                                                                                        await Share.share(
                                                                                                                ...
                                                                                                                if (!columnUserRecord.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(10, 0, 0, 0),
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_D_P_NEW_PAGE_Icon_xux56z1e_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                                                                                ...
                                                                                                                if (columnUserRecord.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_D_P_NEW_PAGE_Icon_eczvo1x5_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'P_D_P_NEW_PAGE_Text_82bwba7f_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Text_navigate_to');
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'P_D_P_NEW_PAGE_APPLY_FOR_LOAN_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_navigate_to');
                                      ...
                                      Expanded(
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'P_D_P_NEW_EXPRESS_INTEREST_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_navigate_to');
