...
import 'p_l_p_new_search_model.dart';
export 'p_l_p_new_search_model.dart';

class PLPNewSearchWidget extends StatefulWidget {
  const PLPNewSearchWidget({
    Key? key,
    this.searchkeyword,
    bool? carousels,
    this.trending,
  })  : this.carousels = carousels ?? false,
        super(key: key);
  ...
  @override
  _PLPNewSearchWidgetState createState() => _PLPNewSearchWidgetState();
}

class _PLPNewSearchWidgetState extends State<PLPNewSearchWidget> {
  late PLPNewSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PLPNewSearchModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PLP_NewSearch'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_L_P_NEW_SEARCH_PLP_NewSearch_ON_LOAD');
      if (!FFAppState().filterAppliedSearch) {
        logFirebaseEvent('PLP_NewSearch_update_app_state');
        FFAppState().update(() {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PropertiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertiesRecord> pLPNewSearchPropertiesRecordList =
            snapshot.data!;
        return Title(
            title: 'PLP_NewSearch',
                                ...
                                children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'P_L_P_NEW_SEARCH_Stack_njdsu152_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Stack_navigate_to');
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'P_L_P_NEW_SEARCH_Image_uwcx04kd_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Image_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_SEARCH_Icon_guz9ut9k_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_SEARCH_Icon_gp9knekz_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_NEW_SEARCH_Icon_y4g3xu2r_ON_TAP');
                                                                      if (functions.mapLength(containerUserRecord!
                                                                              .cart!
                                                                              .toList()) >
                                                                          0) {
                                                                        logFirebaseEvent(
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_SEARCH_Icon_w1h2k3o1_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                    ...
                                                    if (!FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_NEW_SEARCH_Icon_yrcdt20p_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon_navigate_to');
                                                            ...
                                                            context.pushNamed(
                                                              ...
                                                              queryParams: {
                                                                ...
                                                                'props':
                                                                    serializeParam(
                                                                  pLPNewSearchPropertiesRecordList,
                                                                  ParamType
                                                                      .Document,
                                                                  true,
                                                                ),
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_NEW_SEARCH_Image_p9jqxk4x_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Image_navigate_to');
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Search Results : \"${widget.searchkeyword}\"',
                                                          ...
                                                          pLPNewSearchPropertiesRecordList
                                                              .where((e) =>
                                                                  ...
                                                                  ((e.auctionReservePrice! >=
                                                                      ...
                                                                      (e.auctionReservePrice! <=
                                                                          functions
                                                                              .returnPrice(FFAppState().filterMaxBudget)!)))
                                                              .toList();
                                                      if (ref.isEmpty) {
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_NEW_SEARCH_Row_oe9eoaye_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_jyl71qo8_ON_TAP');
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_0640576v_ON_TAP');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_9zqkx3l2_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                                ...
                                                                .where((e) =>
                                                                    ...
                                                                    ((e.auctionReservePrice! >=
                                                                            functions.returnPrice(FFAppState()
                                                                                .filterMinBudget)!) &&
                                                                        (e.auctionReservePrice! <=
                                                                            functions.returnPrice(FFAppState().filterMaxBudget)!)))
                                                                .toList();
                                                        if (ref1.isEmpty) {
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_L_P_NEW_SEARCH_Row_w417swqg_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Row(
                                                                                                              ...
                                                                                                              children: [
                                                                                                                ...
                                                                                                                if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.propertyId))
                                                                                                                  Padding(
                                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0, 0, 10, 0),
                                                                                                                    child: SvgPicture.asset(
                                                                                                                      'assets/images/Hot_Icon.svg',
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Builder(
                                                                                                                  builder: (context) => Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_cz6xwctq_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_share');
                                                                                                                        await Share.share(
                                                                                                                          '${rowPropertiesRecord.title}%0A%0AReserve Price : ${valueOrDefault<String>(
                                                                                                                            functions.format(rowPropertiesRecord.auctionReservePrice),
                                                                                                                ...
                                                                                                                if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_nnu84n52_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                                                                                ...
                                                                                                                if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_SEARCH_Icon_z3uhzqk1_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
