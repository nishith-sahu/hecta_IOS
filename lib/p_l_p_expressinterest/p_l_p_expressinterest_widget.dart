...
import 'p_l_p_expressinterest_model.dart';
export 'p_l_p_expressinterest_model.dart';

class PLPExpressinterestWidget extends StatefulWidget {
  const PLPExpressinterestWidget({
    Key? key,
    this.pageNum,
    this.carousels,
    this.title,
  ...
  @override
  _PLPExpressinterestWidgetState createState() =>
      _PLPExpressinterestWidgetState();
}

class _PLPExpressinterestWidgetState extends State<PLPExpressinterestWidget> {
  late PLPExpressinterestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PLPExpressinterestModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PLPExpressinterest'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_L_P_EXPRESSINTEREST_PLPExpressinterest');
      if (!FFAppState().filterAppliedEOI) {
        logFirebaseEvent('PLPExpressinterest_update_app_state');
        FFAppState().update(() {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PropertiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertiesRecord> pLPExpressinterestPropertiesRecordList =
            snapshot.data!;
        return Title(
            title: 'PLPExpressinterest',
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'P_L_P_EXPRESSINTEREST_Stack_trfm1cvy_ON_');
                                                      logFirebaseEvent(
                                                          'Stack_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_EXPRESSINTEREST_Icon_1rmqm85t_ON_T');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_EXPRESSINTEREST_Icon_xvffarf0_ON_T');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_EXPRESSINTEREST_Icon_gptjj8b1_ON_T');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_EXPRESSINTEREST_Icon_a0tephoc_ON_T');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                    ...
                                                    if (!FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_EXPRESSINTEREST_Icon_euyxp44t_ON_T');
                                                            logFirebaseEvent(
                                                                'Icon_navigate_to');
                                                            ...
                                                            context.pushNamed(
                                                              ...
                                                              queryParams: {
                                                                ...
                                                                'props':
                                                                    serializeParam(
                                                                  pLPExpressinterestPropertiesRecordList,
                                                                  ParamType
                                                                      .Document,
                                                                  true,
                                                                ),
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_EXPRESSINTEREST_Image_q06c0m05_ON_');
                                                            logFirebaseEvent(
                                                                'Image_navigate_to');
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_EXPRESSINTEREST_Row_a11b5w4p_ON_TA');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_4yap74qy_ON_T');
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_l63f8502_ON_T');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_21bwsthh_ON_T');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                        ...
                                                        final ref1 =
                                                            pLPExpressinterestPropertiesRecordList
                                                                .where((e) =>
                                                                    ...
                                                                    ((e.auctionReservePrice! >= functions.returnPrice(FFAppState().filterMinBudget)!) &&
                                                                        (e.auctionReservePrice! <=
                                                                            functions.returnPrice(FFAppState()
                                                                                .filterMaxBudget)!)))
                                                                .toList()
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_L_P_EXPRESSINTEREST_Row_l0fp2t2k_ON_TA');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Builder(
                                                                                                                  builder: (context) => Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_yti7g55d_ON_T');
                                                                                                                        logFirebaseEvent('Icon_share');
                                                                                                                        await Share.share(
                                                                                                                          '${widget.title}%0A%0AReserve Price : ${valueOrDefault<String>(
                                                                                                                            functions.format(rowPropertiesRecord.auctionReservePrice),
                                                                                                                ...
                                                                                                                if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_hkepstha_ON_T');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                                                                                ...
                                                                                                                if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_EXPRESSINTEREST_Icon_gpiitld1_ON_T');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
