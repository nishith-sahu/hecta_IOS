...
class TwowaySilderFilter extends StatefulWidget {
  const TwowaySilderFilter({
    Key? key,
    this.width,
    this.height,
  }) : super(key: key);
  ...
  @override
  _TwowaySilderFilterState createState() => _TwowaySilderFilterState();
}
...
RangeValues _currentRangeValues = RangeValues(
    budgetMap3[FFAppState().selectedminBudget]!.toDouble(),
    budgetMap3[FFAppState().selectedmaxBudget]!.toDouble());
...
class _TwowaySilderFilterState extends State<TwowaySilderFilter> {
  @override
