...
import 'cart_screen1_new_copy_model.dart';
export 'cart_screen1_new_copy_model.dart';

class CartScreen1NewCopyWidget extends StatefulWidget {
  const CartScreen1NewCopyWidget({Key? key}) : super(key: key);

  @override
  _CartScreen1NewCopyWidgetState createState() =>
      _CartScreen1NewCopyWidgetState();
}

class _CartScreen1NewCopyWidgetState extends State<CartScreen1NewCopyWidget> {
  late CartScreen1NewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartScreen1NewCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'cart_Screen1_newCopy'});
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CART_SCREEN1_NEW_COPY_Icon_3m9eu4zt_ON_T');
                                                                          logFirebaseEvent(
                                                                              'Icon_backend_call');
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'CART_SCREEN1_NEW_COPY_CHECKOUT_BTN_ON_TA');
                                                  logFirebaseEvent(
                                                      'Button_backend_call');
