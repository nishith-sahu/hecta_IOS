...
import 'filters_new_model.dart';
export 'filters_new_model.dart';

class FiltersNewWidget extends StatefulWidget {
  const FiltersNewWidget({
    Key? key,
    this.fromSearch,
    this.props,
    this.carousels,
  ...
  @override
  _FiltersNewWidgetState createState() => _FiltersNewWidgetState();
}

class _FiltersNewWidgetState extends State<FiltersNewWidget> {
  late FiltersNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FiltersNewModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'FiltersNew'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('FILTERS_NEW_PAGE_FiltersNew_ON_PAGE_LOAD');
      logFirebaseEvent('FiltersNew_update_app_state');
      FFAppState().update(() {
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'FILTERS_NEW_PAGE_Icon_xqa15w0m_ON_TAP');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'FILTERS_NEW_PAGE_Text_9wrkex9z_ON_TAP');
                                        logFirebaseEvent(
                                        ...
                                        FFAppState().update(() {
                                          ...
                                          FFAppState().selectedminBudget = '0';
                                        ...
                                        FFAppState().update(() {
                                          ...
                                          FFAppState().selectedAucDateEnd =
                                              getCurrentTimestamp;
                                          FFAppState().selectedAllowOpen = true;
                                        });
                                      },
                                      child: Text(
                                        'Clear All',
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                          ...
                                          expanded: Row(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'FILTERS_NEW_PAGE_Row_h5uqymov_ON_TAP');
                                                  logFirebaseEvent(
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'FILTERS_NEW_PAGE_Row_g3albj51_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_date_time_picker');
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(15, 18, 15, 0),
                            child: Container(
                              width: double.infinity,
                              height: 1,
                              decoration: BoxDecoration(
                                          ...
                                          expanded: Row(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'FILTERS_NEW_PAGE_Row_qipaf6bs_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_date_time_picker');
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'FILTERS_NEW_PAGE_Row_tp6xpg7g_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_date_time_picker');
                                                  ...
                                                  fieldViewBuilder: (
                                                    ...
                                                    return TextFormField(
                                                      ...
                                                      onChanged: (_) =>
                                                        ...
                                                        () async {
                                                          logFirebaseEvent(
                                                              'FILTERS_NEW_TextField_g8b8d6vh_ON_TEXTFI');
                                                          logFirebaseEvent(
                                                      ...
                                                      return Wrap(
                                                        ...
                                                        children: List.generate(
                                                          ...
                                                          return InkWell(
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'FILTERS_NEW_Container_lv9o3fy3_ON_TAP');
                                                              if (FFAppState()
                                                                  .selectedStates
                                                                  .contains(
                                                                      statesItem)) {
                                                                ...
                                                                FFAppState()
                                                                  ...
                                                                  FFAppState()
                                                                      .removeFromSelectedStates(
                                                                          statesItem);
                                                                  FFAppState().selectedCities = functions
                                                                      .removeCommon(
                                                                          FFAppState()
                                                                              .selectedCities
                                                                              .toList(),
                                                                    ...
                                                                    child: Text(
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            ...
                                                                            color: FFAppState().selectedStates.contains(statesItem)
                                                                                ? Colors.white
                                                                                : Color(0xFF091E25),
                                                                            fontSize:
                                                                                12,
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FILTERS_NEW_PAGE_Text_y3lyceia_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Text_update_app_state');
                                                        FFAppState().update(() {
                                                          FFAppState()
                                                    ...
                                                    fieldViewBuilder: (
                                                      ...
                                                      return TextFormField(
                                                        ...
                                                        onFieldSubmitted:
                                                            (_) async {
                                                          logFirebaseEvent(
                                                              'FILTERS_NEW_TextField_6221pz3t_ON_TEXTFI');
                                                          logFirebaseEvent(
                                                              'TextField_update_app_state');
                                                          FFAppState()
                                                              .update(() {
                                                        ...
                                                        return Wrap(
                                                          ...
                                                          children:
                                                            ...
                                                            return InkWell(
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'FILTERS_NEW_Container_jupzqi83_ON_TAP');
                                                                if (FFAppState()
                                                                    .selectedCities
                                                                    .contains(
                                                                        cityItem)) {
                                                                  ...
                                                                  FFAppState()
                                                                    ...
                                                                    FFAppState()
                                                                        .removeFromSelectedCities(
                                                                            cityItem);
                                                                    FFAppState().selectedLocs = functions
                                                                        .removeCommon(
                                                                            FFAppState().selectedLocs.toList(),
                                                                            widget.props!.where((e) => e.city == cityItem).toList().map((e) => e.location).withoutNulls.toList())
                                                                        .toList();
                                                                  });
                                                                } else {
                                                                  logFirebaseEvent(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FILTERS_NEW_PAGE_Text_9ncaqxfh_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Text_update_app_state');
                                                          FFAppState()
                                                              .update(() {
                                                    ...
                                                    fieldViewBuilder: (
                                                      ...
                                                      return TextFormField(
                                                        ...
                                                        onFieldSubmitted:
                                                            (_) async {
                                                          logFirebaseEvent(
                                                              'FILTERS_NEW_TextField_692dsem4_ON_TEXTFI');
                                                          logFirebaseEvent(
                                                              'TextField_update_app_state');
                                                          FFAppState()
                                                              .update(() {
                                                        ...
                                                        return Wrap(
                                                          ...
                                                          children:
                                                            ...
                                                            return InkWell(
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'FILTERS_NEW_Container_kihkngn3_ON_TAP');
                                                                if (FFAppState()
                                                                    .selectedLocs
                                                                    .contains(
                                                                        locItem)) {
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'FILTERS_NEW_PAGE_Text_a2t223jr_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Text_update_app_state');
                                                          FFAppState()
                                                              .update(() {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    width: double.infinity,
                                    height: 80,
                                    child: custom_widgets.TwowaySilderFilter(
                                      width: double.infinity,
                                      height: 80,
                                    ),
                                  ),
                                                  ...
                                                  fieldViewBuilder: (
                                                    ...
                                                    return TextFormField(
                                                      ...
                                                      onFieldSubmitted:
                                                          (_) async {
                                                        logFirebaseEvent(
                                                            'FILTERS_NEW_TextField_vzws1ypj_ON_TEXTFI');
                                                        logFirebaseEvent(
                                                            'TextField_update_app_state');
                                                        FFAppState().update(() {
                                                          FFAppState()
                                                      ...
                                                      return Wrap(
                                                        ...
                                                        children: List.generate(
                                                          ...
                                                          return InkWell(
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'FILTERS_NEW_Container_3797zb42_ON_TAP');
                                                              if (FFAppState()
                                                                  .selectedTypes
                                                                  .contains(
                                                                      typeItem)) {
                                                                    ...
                                                                    child: Text(
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            fontFamily:
                                                                                FlutterFlowTheme.of(context).bodyText1Family,
                                                                            color: FFAppState().selectedTypes.contains(typeItem)
                                                                                ? Colors.white
                                                                                : Color(0xFF091E25),
                                                                            fontSize:
                                                                                12,
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FILTERS_NEW_PAGE_Text_wkz5w8bq_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Text_update_app_state');
                                                        FFAppState().update(() {
                                                          FFAppState()
                                                  ...
                                                  fieldViewBuilder: (
                                                    ...
                                                    return TextFormField(
                                                      ...
                                                      onFieldSubmitted:
                                                          (_) async {
                                                        logFirebaseEvent(
                                                            'FILTERS_NEW_TextField_yermm7lm_ON_TEXTFI');
                                                        logFirebaseEvent(
                                                            'TextField_update_app_state');
                                                        FFAppState().update(() {
                                                          FFAppState()
                                                      ...
                                                      return Wrap(
                                                        ...
                                                        children: List.generate(
                                                          ...
                                                          return InkWell(
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'FILTERS_NEW_Container_an89a6dk_ON_TAP');
                                                              if (FFAppState()
                                                                  .selectedBanks
                                                                  .contains(
                                                                      banksItem)) {
                                                                    ...
                                                                    child: Text(
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            fontFamily:
                                                                                FlutterFlowTheme.of(context).bodyText1Family,
                                                                            color: FFAppState().selectedBanks.contains(banksItem)
                                                                                ? Colors.white
                                                                                : Color(0xFF091E25),
                                                                            fontSize:
                                                                                12,
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'FILTERS_NEW_PAGE_Text_sn7zpxsi_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Text_update_app_state');
                                                        FFAppState().update(() {
                                                          FFAppState()
                            ...
                            children: [
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'FILTERS_NEW_SHOW_PROPERTIES_BTN_ON_TAP');
                                    logFirebaseEvent('Button_update_app_state');
                                    FFAppState().update(() {
                                      FFAppState().filterCity =
                                          FFAppState().selectedCities.toList();
                                      FFAppState().filterType =
                                          FFAppState().selectedTypes.toList();
                                      FFAppState().filterArea =
                                          FFAppState().selectedLocs.toList();
                                      FFAppState().filterState =
                                          FFAppState().selectedStates.toList();
                                      FFAppState().filterBanks =
                                          FFAppState().selectedBanks.toList();
                                    ...
                                    if (widget.fromSearch!) {
                                      ...
                                      FFAppState().update(() {
                                        ...
                                        FFAppState().filterAppliedSearch = true;
                                        FFAppState().filterAppliedCarousels =
                                            false;
                                        FFAppState().filterAppliedEOI = false;
                                        FFAppState().filterAppliedFav = false;
                                    ...
                                    if (widget.fav!) {
                                      ...
                                      FFAppState().update(() {
                                        ...
                                        FFAppState().filterAppliedCarousels =
                                            false;
                                        FFAppState().filterAppliedEOI = false;
                                        FFAppState().filterAppliedFav = true;
                                        FFAppState().filterAppliedSimilar =
                                            false;
                                      });
                                    }
                                    if (widget.eoi!) {
                                      ...
                                      FFAppState().update(() {
                                        ...
                                        FFAppState().filterAppliedCarousels =
                                            false;
                                        FFAppState().filterAppliedEOI = true;
                                        FFAppState().filterAppliedFav = false;
                                        FFAppState().filterAppliedSimilar =
                                            false;
                                      });
