...
import 'p_l_p_fav_model.dart';
export 'p_l_p_fav_model.dart';

class PLPFavWidget extends StatefulWidget {
  const PLPFavWidget({
    Key? key,
    this.pageNum,
    this.carousels,
  ...
  @override
  _PLPFavWidgetState createState() => _PLPFavWidgetState();
}

class _PLPFavWidgetState extends State<PLPFavWidget> {
  late PLPFavModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PLPFavModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'PLP_Fav'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_L_P_FAV_PAGE_PLP_Fav_ON_PAGE_LOAD');
      if (!FFAppState().filterAppliedFav) {
        logFirebaseEvent('PLP_Fav_update_app_state');
        FFAppState().update(() {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PropertiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertiesRecord> pLPFavPropertiesRecordList = snapshot.data!;
        return Title(
            title: 'PLP_Fav',
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'P_L_P_FAV_PAGE_Stack_e4fcreal_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Stack_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_FAV_PAGE_Icon_2b16j5kj_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_FAV_PAGE_Icon_apxledwx_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_FAV_PAGE_Icon_s8l0w1f3_ON_TAP');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_FAV_PAGE_Icon_m2zeu1zx_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                    ...
                                                    if (!FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_FAV_PAGE_Icon_nsamovk4_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon_navigate_to');
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_FAV_PAGE_Image_62zrgo24_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Image_navigate_to');
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_FAV_PAGE_Row_z9wyimbm_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_FAV_PAGE_Icon_uupbsl2v_ON_TAP');
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_FAV_PAGE_Icon_hkjljl6o_ON_TAP');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_FAV_PAGE_Icon_wuh9bv8t_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_L_P_FAV_PAGE_Row_e2z9b5zd_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Builder(
                                                                                                                  builder: (context) => Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_FAV_PAGE_Icon_uhm1jnv2_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_share');
                                                                                                                        await Share.share(
                                                                                                                          '${widget.title}%0A%0AReserve Price : ${valueOrDefault<String>(
                                                                                                                            functions.format(rowPropertiesRecord.auctionReservePrice),
                                                                                                                ...
                                                                                                                if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_FAV_PAGE_Icon_ah1riddy_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                                                                                ...
                                                                                                                if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_FAV_PAGE_Icon_op4m3s3i_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
