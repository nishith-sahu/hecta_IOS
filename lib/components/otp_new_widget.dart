...
import 'otp_new_model.dart';
export 'otp_new_model.dart';

class OtpNewWidget extends StatefulWidget {
  const OtpNewWidget({
    Key? key,
    this.otp,
    this.phoneNumber,
  ...
  @override
  _OtpNewWidgetState createState() => _OtpNewWidgetState();
}

class _OtpNewWidgetState extends State<OtpNewWidget> {
  late OtpNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtpNewModel());
            ...
            children: [
              Padding(
                ...
                child: PinCodeTextField(
                  ...
                  onCompleted: (_) async {
                    logFirebaseEvent(
                        'OTP_NEW_PinCode_gucc3wf4_ON_PINCODE_COMP');
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent('OTP_NEW_COMP_Text_3intjugc_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: functions.otplength(FFAppState().pincode)
                      ? null
                      : () async {
                          logFirebaseEvent('OTP_NEW_COMP_VERIFY_BTN_ON_TAP');
