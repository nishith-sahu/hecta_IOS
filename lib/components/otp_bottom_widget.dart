...
import 'otp_bottom_model.dart';
export 'otp_bottom_model.dart';

class OtpBottomWidget extends StatefulWidget {
  ...
  @override
  _OtpBottomWidgetState createState() => _OtpBottomWidgetState();
}

class _OtpBottomWidgetState extends State<OtpBottomWidget> {
  late OtpBottomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtpBottomModel());
            ...
            children: [
              Padding(
                ...
                child: PinCodeTextField(
                  ...
                  onCompleted: (_) async {
                    logFirebaseEvent(
                        'OTP_BOTTOM_PinCode_2u1s8mo6_ON_PINCODE_C');
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent(
                              'OTP_BOTTOM_COMP_Text_7otrhm2x_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: !functions.otplength(FFAppState().pincode)
                      ? null
                      : () async {
                          logFirebaseEvent('OTP_BOTTOM_COMP_VERIFY_BTN_ON_TAP');
