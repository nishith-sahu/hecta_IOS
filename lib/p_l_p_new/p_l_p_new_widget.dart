...
import 'p_l_p_new_model.dart';
export 'p_l_p_new_model.dart';

class PLPNewWidget extends StatefulWidget {
  const PLPNewWidget({
    Key? key,
    this.pageNum,
    this.carousels,
  ...
  @override
  _PLPNewWidgetState createState() => _PLPNewWidgetState();
}

class _PLPNewWidgetState extends State<PLPNewWidget> {
  late PLPNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PLPNewModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'PLP_New'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_L_P_NEW_PAGE_PLP_New_ON_PAGE_LOAD');
      if (!FFAppState().filtersApplied) {
        logFirebaseEvent('PLP_New_update_app_state');
        FFAppState().update(() {
          ...
          FFAppState().filterMaxBudget = valueOrDefault<String>(
            valueOrDefault(currentUserDocument?.budgetTo, ''),
            '1000Cr+',
          );
          FFAppState().filterMinBudget = valueOrDefault<String>(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PropertiesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertiesRecord> pLPNewPropertiesRecordList = snapshot.data!;
        return Title(
            title: 'PLP_New',
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'P_L_P_NEW_PAGE_Stack_epyqd91u_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Stack_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_PAGE_Icon_z6erxgqc_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_PAGE_Icon_ruk6ri9p_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_NEW_PAGE_Icon_o7pczx6u_ON_TAP');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_NEW_PAGE_Icon_7wdwc20j_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                    ...
                                                    if (!FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_NEW_PAGE_Icon_d9khswzo_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon_navigate_to');
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_NEW_PAGE_Image_z8agkza3_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Image_navigate_to');
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'Properties handpicked based on your requirements',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText1
                                                        .override(
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_NEW_PAGE_Row_ksrft6gd_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_PAGE_Icon_hm24ffch_ON_TAP');
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_PAGE_Icon_4y0m4axr_ON_TAP');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_NEW_PAGE_Icon_tqs5yvxk_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'P_L_P_NEW_PAGE_Row_cfwief3f_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                                                              ...
                                                                                                              children: [
                                                                                                                Builder(
                                                                                                                  builder: (context) => Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_PAGE_Icon_d8wvhcz4_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_share');
                                                                                                                        await Share.share(
                                                                                                                          '${widget.title}%0A%0AReserve Price : ${valueOrDefault<String>(
                                                                                                                            functions.format(rowPropertiesRecord.auctionReservePrice),
                                                                                                                ...
                                                                                                                if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_PAGE_Icon_cy34uwcu_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
                                                                                                                ...
                                                                                                                if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: InkWell(
                                                                                                                      onTap: () async {
                                                                                                                        logFirebaseEvent('P_L_P_NEW_PAGE_Icon_e8o4fxdo_ON_TAP');
                                                                                                                        logFirebaseEvent('Icon_backend_call');
