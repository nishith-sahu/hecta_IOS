...
import 'requirements_new_model.dart';
export 'requirements_new_model.dart';

class RequirementsNewWidget extends StatefulWidget {
  const RequirementsNewWidget({
    Key? key,
    this.fromSearch,
  }) : super(key: key);
  ...
  @override
  _RequirementsNewWidgetState createState() => _RequirementsNewWidgetState();
}

class _RequirementsNewWidgetState extends State<RequirementsNewWidget> {
  late RequirementsNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequirementsNewModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Requirements_New'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('REQUIREMENTS_NEW_Requirements_New_ON_LOA');
      if (!widget.fromSearch!) {
        logFirebaseEvent('Requirements_New_update_app_state');
        FFAppState().update(() {
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'REQUIREMENTS_NEW_Container_p0774xcq_ON_T');
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'REQUIREMENTS_NEW_Icon_p2dvl5oh_ON_TAP');
                                                            logFirebaseEvent(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'REQUIREMENTS_NEW_Image_0xsvm98y_ON_TAP');
                                                      if (!FFAppState()
                                                          .citiesPref
                                                          .contains(
                                                              'New Delhi')) {
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'REQUIREMENTS_NEW_Image_p0qyu99w_ON_TAP');
                                                      if (!FFAppState()
                                                          .citiesPref
                                                          .contains(
                                                              'Gurugram')) {
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'REQUIREMENTS_NEW_Image_xjpjfii6_ON_TAP');
                                                      if (!FFAppState()
                                                          .citiesPref
                                                          .contains('Noida')) {
                                                        logFirebaseEvent(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'REQUIREMENTS_NEW_Image_6dx82ib8_ON_TAP');
                                                      if (!FFAppState()
                                                          .citiesPref
                                                          .contains('Mumbai')) {
                                                        logFirebaseEvent(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUIREMENTS_NEW_Image_4p1n5570_ON_TAP');
                                                        if (!FFAppState()
                                                            .citiesPref
                                                            .contains(
                                                                'Bengaluru')) {
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'REQUIREMENTS_NEW_Container_33t8oq9a_ON_T');
                                                  logFirebaseEvent(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: InkWell(
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'REQUIREMENTS_NEW_Image_n3fntkyy_ON_TAP');
                                                          if (!FFAppState()
                                                              .citiesPref
                                                              .contains(
                                                                  'Chennai')) {
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUIREMENTS_NEW_Image_4px3yrlq_ON_TAP');
                                                        if (!FFAppState()
                                                            .citiesPref
                                                            .contains(
                                                                'Hyderabad')) {
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'REQUIREMENTS_NEW_Image_cz48ff0w_ON_TAP');
                                                        if (!FFAppState()
                                                            .citiesPref
                                                            .contains('Pune')) {
                                                          logFirebaseEvent(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_9e0aqrpz_ON_TAP');
                                                    if (FFAppState().rf) {
                                                      logFirebaseEvent(
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_bnf6rzm2_ON_TAP');
                                                    if (FFAppState().ih) {
                                                      logFirebaseEvent(
                                                          'Row_update_app_state');
                                                      FFAppState().update(() {
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'REQUIREMENTS_NEW_Row_qbdm1q92_ON_TAP');
                                                  if (FFAppState().cp) {
                                                    logFirebaseEvent(
                                                        'Row_update_app_state');
                                                    FFAppState().update(() {
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_03jmjgiv_ON_TAP');
                                                    if (FFAppState().off) {
                                                      logFirebaseEvent(
                                                          'Row_update_app_state');
                                                      FFAppState().update(() {
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'REQUIREMENTS_NEW_Row_5n2172fp_ON_TAP');
                                                  if (FFAppState().al) {
                                                    logFirebaseEvent(
                                                        'Row_update_app_state');
                                                    FFAppState().update(() {
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_m2k9ieuv_ON_TAP');
                                                    if (FFAppState().rp) {
                                                      logFirebaseEvent(
                                                          'Row_update_app_state');
                                                      FFAppState().update(() {
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'REQUIREMENTS_NEW_Row_v54lwf1f_ON_TAP');
                                                  if (FFAppState().lnb) {
                                                    logFirebaseEvent(
                                                        'Row_update_app_state');
                                                    FFAppState().update(() {
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_ppyramvo_ON_TAP');
                                                    if (FFAppState().ip) {
                                                      logFirebaseEvent(
                                                          'Row_update_app_state');
                                                      FFAppState().update(() {
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'REQUIREMENTS_NEW_Row_txp5cycn_ON_TAP');
                                                    if (FFAppState().sh) {
                                                      logFirebaseEvent(
                                                          'Row_update_app_state');
                                                      FFAppState().update(() {
                          ...
                          children: [
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'REQUIREMENTS_NEW_PAGE_SAVE_BTN_ON_TAP');
