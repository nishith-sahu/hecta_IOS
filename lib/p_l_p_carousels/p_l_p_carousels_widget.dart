...
import 'p_l_p_carousels_model.dart';
export 'p_l_p_carousels_model.dart';

class PLPCarouselsWidget extends StatefulWidget {
  const PLPCarouselsWidget({
    Key? key,
    this.title,
    this.trending,
  }) : super(key: key);
  ...
  @override
  _PLPCarouselsWidgetState createState() => _PLPCarouselsWidgetState();
}

class _PLPCarouselsWidgetState extends State<PLPCarouselsWidget> {
  late PLPCarouselsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PLPCarouselsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PLP_Carousels'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('P_L_P_CAROUSELS_PLP_Carousels_ON_LOAD');
      if (!FFAppState().filterAppliedCarousels) {
        logFirebaseEvent('PLP_Carousels_update_app_state');
        FFAppState().update(() {
      ...
      if (functions.filterONorOFF(
        ...
        logFirebaseEvent('PLP_Carousels_update_app_state');
        setState(() {
          FFAppState().filterAppliedCarousels = true;
        });
      }
    });
                    ...
                    child: StreamBuilder<List<PropertiesRecord>>(
                      stream: queryPropertiesRecord(
                        queryBuilder: (propertiesRecord) =>
                            propertiesRecord.whereIn('product_categories',
                                functions.carouselsProp(widget.title!)),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'P_L_P_CAROUSELS_Stack_ixkv53ch_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Stack_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_CAROUSELS_Icon_bh0lv7eh_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_CAROUSELS_Icon_ynaxziy6_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_CAROUSELS_Icon_5ofe7kb6_ON_TAP');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'P_L_P_CAROUSELS_Icon_xjnsvioc_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_navigate_to');
                                                    ...
                                                    if (!FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_CAROUSELS_Icon_387vpd32_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon_navigate_to');
                                                    ...
                                                    if (FFAppState()
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'P_L_P_CAROUSELS_Image_l4zo94ml_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Image_navigate_to');
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_CAROUSELS_PAGE_Row_0h2jfeg2_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_zopfrg1n_ON_TAP');
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_ac5bdpk5_ON_TAP');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_pj7c0wo0_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'P_L_P_CAROUSELS_PAGE_Row_lybpkqxd_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_navigate_to');
                                                                                                            ...
                                                                                                            children: [
                                                                                                              Builder(
                                                                                                                builder: (context) => Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_ko5re76j_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_share');
                                                                                                                      await Share.share(
                                                                                                                        '${widget.title}%0A%0AReserve Price : ${valueOrDefault<String>(
                                                                                                                          functions.format(rowPropertiesRecord.auctionReservePrice),
                                                                                                              ...
                                                                                                              if (!containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_zihlg7cy_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
                                                                                                              ...
                                                                                                              if (containerUserRecord!.likedProperties!.toList().contains(rowPropertiesRecord.uid))
                                                                                                                Padding(
                                                                                                                  ...
                                                                                                                  child: InkWell(
                                                                                                                    onTap: () async {
                                                                                                                      logFirebaseEvent('P_L_P_CAROUSELS_Icon_tg0x22wr_ON_TAP');
                                                                                                                      logFirebaseEvent('Icon_backend_call');
